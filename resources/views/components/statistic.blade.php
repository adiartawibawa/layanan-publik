...
<div
    class="bw-statistic bg-white dark:bg-slate-800/80 dark:border dark:border-slate-700/50 p-6 rounded-md relative @if ($has_shadow) shadow-2xl shadow-gray-200/40 dark:shadow-xl dark:shadow-slate-900 @endif{{ $class }}">
    <div class="flex space-x-4">
        ...
        <div class="grow number">
            ...
            <div class="text-3xl text-gray-500/90 font-light">
                ...
                @endif
                <span
                    class="figure tracking-wider dark:text-slate-400 font-semibold {{ $number_css }}">{{ $number }}</span>
