...
@endphp
<div
    class="bw-card bg-white dark:bg-slate-900 dark:border dark:border-slate-800/50 @if ($header === null && !$reduce_padding) p-8 @elseif($reduce_padding) p-4 @else @endif rounded-lg @if ($has_shadow) shadow-2xl shadow-gray-200/40 dark:shadow-xl dark:shadow-slate-900 @endif {{ $class }}">
    @if ($header)
