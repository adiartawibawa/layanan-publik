                    ...
                    <section>
                        ...
                        <x-modal name="tambah-layanan" focusable>
                            <form method="post" action="{{ route('admin.pelayanan.store') }}" class="p-6">
                                ...
                                <div class="mt-6">
                                    <x-input label="Nama Layanan" name="name" required="true"
                                        value="{{ old('name') }}" autofocus />
                                    <x-input-error :messages="$errors->get('name')" class="mt-1" />
                                </div>
                                <div class="mt-4">
                                    <x-input label="Estimasi Waktu Layanan" name="estimasi" suffix="Hari Layanan "
                                        numeric="true" required="true" value="{{ old('estimasi') }}" autofocus />
                                    <x-input-error :messages="$errors->get('estimasi')" class="mt-1" />
                                </div>
                                <div class="mt-4">
                                    <x-textarea label="Deskripsi Layanan" name="desc" required="true"
